function levelSensorMimic(){
	...
	$("#diagram").html("");
//	$("#diagram").html(" <img src='images/mimic.png' class='img-fluid' style='border-style: double;border-color: black;'>");
//	
//	htm=''
...
//		+'<div class="row">'
//		+'<div class="col-sm-3">'
//		+'<button id="fillTankBtn" class="btn btn-danger" style="width:100%">FILL TANK</button>'
//		+'</div>'
//		+'<div class="col-sm-3">'
...
//		+'<div class="row">'
//		+'<div class="col-sm-8">'
//		+'<label><b>Ultrasonic Sensor (LT-1) :</b></label>'
//		+'</div>'		
//		+'<div class="col-sm-3">'
//		+'<label class="PMCValue" id="lt1Val">0</label>'
//		+'</div>'		
//		+'<div class="col-sm-1">'
//		+'<label class=""><b><center>mm</center></b></label>'
//		+'</div>'
//		+'</div>'
//		
//		+'<div class="row">'
//		+'<div class="col-sm-8">'
//		+'<label><b>Capacitive Sensor (LT-2) :</b></label>'
//		+'</div>'		
//		+'<div class="col-sm-3">'
//		+'<label class="PMCValue" id="lt2Val">0</label>'
//		+'</div>'		
//		+'<div class="col-sm-1">'
//		+'<label class=""><b><center>mm</center></b></label>'
//		+'</div>'
...
//		+'<div class="row">'
//		+'<div class="col-sm-8">'
//		+'<label><b>Magnetostrictive Sensor (LT-3) :</b></label>'
//		+'</div>'		
//		+'<div class="col-sm-3">'
//		+'<label class="PMCValue" id="lt3Val"> 0 </label>'
//		+'</div>'		
//		+'<div class="col-sm-1">'
//		+'<label class=""><b><center>mm</center></b></label>'
//		+'</div>'
...
//		+'<div class="row">'
//		+'<div class="col-sm-8">'
//		+'<label><b>Pulse Radar Sensor (LT-4) : </b></label>'
//		+'</div>'		
//		+'<div class="col-sm-3">'
//		+'<label class="PMCValue" id="lt4Val">0 </label>'
//		+'</div>'		
//		+'<div class="col-sm-1">'
//		+'<label class=""><b><center>mm</center></b></label>'
//		+'</div>'
...
//		+'<div class="row">'
//		+'<div class="col-sm-8">'
//		+'<label><b>Guided Wave Radar Sensor (LT-5) : </b></label>'
//		+'</div>'		
//		+'<div class="col-sm-3">'
//		+'<label class="PMCValue" id="lt5Val">0 </label>'
//		+'</div>'		
//		+'<div class="col-sm-1">'
//		+'<label class=""><b><center>mm</center></b></label>'
//		+'</div>'
...
//		+'</div>'
//		+'<div class="col-sm-12">'
//		+'<button type="button" class="btn btn-danger"  id="levelSensorPost" style="margin-top:10px;width:100%" hidden>NEXT LEVEL</button>'
//		+'</div>'
//		
...
//		+' </tr>'
		...
		+'<tbody>'
		+' <tr>'
		+'   <td><label><b>Ultrasonic Sensor (LT-1) :</b></label></td>'
		+'   <td><label class="PMCValue" id="lt1Val">0</label>mm</td>'
		+'  </tr>'
		+'  <tr>'
		+' <td><label><b>Capacitive Sensor (LT-2) :</b></label></td>'
		+' <td><label class="PMCValue" id="lt2Val">0</label>mm</td>'
		+'  </tr>'
		+'  <tr>'
		+' <td><label><b>Magnetostrictive Sensor (LT-3) :</b></label></td>'
		+' <td><label class="PMCValue" id="lt3Val">0</label>mm</td>'
		+'  </tr>'
		+'  <tr>'
		+' <td><label><b>Pulse Radar Sensor (LT-4) : </b></label></td>'
		+' <td><label class="PMCValue" id="lt4Val">0</label>mm</td>'
		+'  </tr>'
		+'  <tr>'
		+' <td><label><b>Guided Wave Radar Sensor (LT-5) :  </b></label></td>'
